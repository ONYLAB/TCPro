...
list = [2 4 6 7 9 12 13 14 15 16 17 10 18 19];
tab = 0.1;
...
% % % % % % % % % % % % 
subplot(1,3,1)
h1 = bar((1:14)-tab,experiment(:,1),0.5);
hold on
h2 = bar((1:14)+tab,IncoAll,0.5);
hold on
errorbar((1:14)+tab,IncoAll,LBIncoAll,UBIncoAll,'s','MarkerFaceColor','auto','LineWidth',1)
title('Proliferation')
ylabel('%Responding Donors')
xticks(1:14);
xticklabels({'Pep2','Pep4', 'Pep6' , 'Pep7', 'Pep9',  'Pep12', 'Pep13', 'Pep14', 'Pep15', 'Pep16', ...
...
ylim([0 100])
box off
plot([11.5 11.5],[0 100],'--')
legend([h1 h2],{'Assay','TCPro'},'Location','NorthWest')

subplot(1,3,2)
bar((1:14)-tab,experiment(:,2),0.5)
hold on
bar((1:14)+tab,ELISAll,0.5)
hold on
errorbar((1:14)+tab,ELISAll,LBELISAll,UBELISAll,'s','MarkerFaceColor','auto','LineWidth',1)
title('ELISpot')
% ylabel('%Responders')
xticks(1:14);
xticklabels({'Pep2','Pep4', 'Pep6' , 'Pep7', 'Pep9',  'Pep12', 'Pep13', 'Pep14', 'Pep15', 'Pep16', ...
...
subplot(1,3,3)
bar((1:14)-tab,experiment(:,3),0.5)
hold on
bar((1:14)+tab,COMBOAll,0.5)
hold on
errorbar((1:14)+tab,COMBOAll,LBCOMBOAll,UBCOMBOAll,'s','MarkerFaceColor','auto','LineWidth',1)

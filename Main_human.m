...
NT1=y_record(numel(t_record),(32+13*N):(31+14*N));
AT_N1=y_record(numel(t_record),(32+14*N):(31+15*N));
AT_M1=y_record(numel(t_record),(32+15*N):(31+16*N));
MT1=y_record(numel(t_record),(32+16*N):(31+17*N));
FT1=y_record(numel(t_record),(32+17*N):(31+18*N));
...
%pars, Vp changes
pars(3)=Vp*scaleVOL;
pars(36+12*N)=ID0*scaleVOL;
pars((44+12*N):(43+13*N))=NT0*scaleVOL;
pars((44+13*N):(43+14*N))=MT0*scaleVOL;
...
numactivatedT = AT_N_vector(end,1);